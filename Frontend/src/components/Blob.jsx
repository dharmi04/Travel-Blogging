  ...
  return (
    <div className='p-6 flex flex-col items-center justify-center h-full'>
      <div className="bg-teal-900 text-center h-40 w-full rounded-xl relative">
        <p className='text-primary text-4xl font-sans font-bold pt-14'>Blogs</p>
        <div className="absolute bottom-0 left-0 w-full h-24 flex items-center justify-center pt-16 ">
          <div className="flex items-center border border-green-900 rounded-lg p-2 bg-white shadow-sm shadow-white">
